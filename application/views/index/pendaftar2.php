    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?=site_url('index/pendaftar')?>">
...
getGrafikPie('pendaftar', <?= $grafik1 ?>, 'Grafik Pendaftar Berdasarkan Prodi 1');
getGrafikPie('grafik2', <?= $grafik2 ?>, 'Grafik Dua Pendaftar Berdasarkan Prodi 2');
